...
class User < ApplicationRecord
  ...
  def self.ransackable_associations(_auth_object = nil)
    %w[avatar_attachment avatar_blob categories posts]
  end

  def self.ransackable_attributes(_auth_object = nil)
    %w[avatar created_at email encrypted_password id id_value name remember_created_at
       reset_password_sent_at reset_password_token slug surname updated_at username]
  end
